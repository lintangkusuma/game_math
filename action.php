...
<center>
	...
	<?php
		...
		echo "<p>Score: ".$_SESSION['scores']."</p>";
	?>
	...
	<?php
		...
		if ($_SESSION['lives'] == 0){
			...
			setcookie('scores', $_SESSION['scores'], time()+3600*24*7);
			...
			$query = "INSERT INTO scores (username, scores, playtime, foto)
						VALUES ('".$_COOKIE['username']."','".$_SESSION['scores']."','".date('Y-m-d H:i:s')."','".$_SESSION['filenameupload']."')";
			//jalankan query
